...
import com.alpenraum.shimstack.home.getFrontSuspensionUIData
import com.alpenraum.shimstack.home.getRearSuspensionUIData
...
fun TireDetails(
    ...
    DetailsCard(title = BaseR.string.tire, bigCard, modifier = modifier) {
        Row(
            ...
            SimpleTextPair(
                heading = stringResource(BaseR.string.rear),
