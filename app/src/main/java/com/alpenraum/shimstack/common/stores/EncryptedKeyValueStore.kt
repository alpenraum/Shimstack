...
class EncryptedKeyValueStore @Inject constructor(
    ...
    private val encryptedSharedPreferences by lazy {
        ...
        val masterKey = MasterKey.Builder(context, ANDROID_KEYSTORE)
    ...
    override fun <T : Any> putObject(key: String?, value: T, clazz: Class<T>) {
    ...
    override fun readDouble(key: String, defaultValue: Double): Double {
        val x = encryptedSharedPreferences.getLong(
            key,
    ...
    override fun <T> readObject(key: String?, type: Class<T>): T? {
